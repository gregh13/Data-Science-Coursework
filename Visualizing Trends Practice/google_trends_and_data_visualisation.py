# -*- coding: utf-8 -*-
"""Google Trends and Data Visualisation_Day_74

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1EZsmk3LFioPx-dxP2ZT2CUgfk2I6RnUO
...
ue_search_max = df_unemployment['UE_BENEFITS_WEB_SEARCH'].max()

print('Largest value for "Unemployemnt Benefits" '
      f'in Web Search: {ue_search_max}')
...
# She uses '.last()' to get the last price to count as the month
# I chose to use .mean() to better represent spread of price fluctuations
...
ax1.plot(df_tesla.MONTH, df_tesla.TSLA_WEB_SEARCH, color='royalblue')
ax2.plot(df_tesla.MONTH, df_tesla.TSLA_USD_CLOSE, color='#E84522')

ax1.set_ylabel('Search Trend', color='royalblue')
ax2.set_ylabel('TSLA Stock Price', color='#E84522')
...
ax1.plot(df_tesla.MONTH, df_tesla.TSLA_WEB_SEARCH, color='royalblue', linewidth=2)
ax2.plot(df_tesla.MONTH, df_tesla.TSLA_USD_CLOSE, color='#E84522', linewidth=2)

ax1.set_ylabel('Search Trend\n', color='royalblue', fontsize=14)
ax2.set_ylabel('\nTSLA Stock Price', color='#E84522', fontsize=14)
